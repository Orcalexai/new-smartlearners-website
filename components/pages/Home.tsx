              ...
              <div className="mb-16">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  {[
                    ...
                    { step: '3', title: 'Learn & improve', desc: 'Step-by-step correction + concept clarity', image: '/step-track-progress.png' },
                  ].map((item, index) => (
                  ...
                  <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <div>
                      ...
                      <div className="text-center p-4 rounded-xl bg-green-500/10 border border-green-500/20">
                        ...
                        <p className="text-gray-400 text-sm mt-1">Parents get daily WhatsApp updates.</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <>
              ...
              <div className="mb-12">
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="glass-card p-8" style={{ borderLeft: '4px solid #a855f7' }}>
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-14 h-14 rounded-xl bg-purple-500/20 flex items-center justify-center text-3xl">👩‍🏫</div>
                      <h3 className="text-2xl font-bold text-white">What Teachers Get</h3>
                    </div>
                    <ul className="space-y-4 text-gray-300">
                      <li className="flex items-start gap-3">
                        <span className="text-purple-400 text-lg">✅</span>
                        <span>Automatic exam correction</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-purple-400 text-lg">✅</span>
                        <span>Step-wise mistake identification</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-purple-400 text-lg">✅</span>
                        <span>Clear marks for every question</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-purple-400 text-lg">✅</span>
                        <span>Exact step where students lost marks</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-purple-400 text-lg">✅</span>
                        <span>Ready-to-use remedial guidance</span>
                      </li>
                    </ul>
                  </div>

                  <div className="glass-card p-8" style={{ borderLeft: '4px solid #ec4899' }}>
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-14 h-14 rounded-xl bg-pink-500/20 flex items-center justify-center text-3xl">💡</div>
                      <h3 className="text-2xl font-bold text-white">How It Helps Schools</h3>
                    </div>
                    <ul className="space-y-4 text-gray-300">
                      <li className="flex items-start gap-3">
                        <span className="text-pink-400 text-lg">✅</span>
                        <span>Saves hours of exam correction time</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-pink-400 text-lg">✅</span>
                        <span>Reduces teacher workload significantly</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-pink-400 text-lg">✅</span>
                        <span>Ensures fair and consistent evaluation</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-pink-400 text-lg">✅</span>
                        <span>Delivers clear academic insights</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-pink-400 text-lg">✅</span>
                        <span>Improves overall learning outcomes</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="glass-card p-8 md:p-12 text-center">
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-6">
                  <button onClick={() => setShowVideoModal(true)} className="btn-primary text-lg px-8 py-4 flex items-center gap-2" style={{ background: 'linear-gradient(135deg, #a855f7, #ec4899)' }}><FaPlay className="text-sm" /> Watch Demo</button>
        ...
        {showVideoModal && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-4xl bg-[#1a1f3a] rounded-2xl overflow-hidden shadow-2xl"
            ...
            >
              ...
              {/* Video Footer */}
              <div className="px-6 py-4 bg-[#0f1628] flex flex-wrap items-center justify-between gap-4">
